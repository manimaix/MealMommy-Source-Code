...
class _MenuListPageState extends State<MenuListPage> {
  ...
  Future<List<Meal>> _fetchAvailableMenus() async {
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  children: [
                    Expanded(
                      child: menus.isEmpty
                          ? const Center(child: Text("No available menus."))
                          : ListView.builder(
                              itemCount: menus.length,
                              itemBuilder: (context, index) {
                                final meal = menus[index];
                                return InkWell(
                                  onTap: () async {
                                    ...
                                    if (isVerified) {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (context) => AlertDialog(
                                          ...
                                          content: const Text(
                                            "You must complete and verify your food safety certifications before editing menu.",
                                          ),
                                          actions: [
                                            TextButton(
                                              onPressed: () =>
                            ...
                            if (isVerified) {
                              ...
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  title: const Text("Verification Required"),
                                  content: const Text(
                                    "You must complete and verify your food safety certifications before adding menu.",
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () => 
